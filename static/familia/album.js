(() => {
  ...
  const places = {
    montevideo: {name:'Montevideo', eyebrow:'El punto de encuentro', coords:[-56.16,-34.90], dx:12, dy:24, text:'Los matrimonios de 1929 y 1935, los nacimientos de Bernardo y Lucy y buena parte de la vida familiar convergen en esta ciudad. En Villa del Cerro, Efraim y Luisa aparecen domiciliados en la calle Portugal.', source:'mat1929'},
    esmirna: {name:'Esmirna · İzmir', mapName:'Esmirna', eyebrow:'La rama Levy · Caballero', coords:[27.14,38.42], dx:-15, dy:3, anchor:'end', text:'Jacobo nació aquí en 1911 y Catalina en 1917, según su matrimonio de 1935. Todavía no están confirmadas las fechas ni los barcos de sus viajes a Uruguay; por eso no se dibuja una ruta fechada desde Esmirna.', source:'mat1935'},
    ...
    israel: {name:'Haifa y Jerusalén', mapName:'Israel', eyebrow:'La vida profesional de Bernardo', coords:[35,32], dx:12, dy:18, text:'Bernardo trabajó en Israel desde 1971: en el hospital Rambam de Haifa y en Hadassah, en Jerusalén. Regresó a Uruguay en 1988. La línea une los lugares de esa etapa; no representa el itinerario exacto del viaje.', source:'smu'},
    rio: {name:'Río de Janeiro', eyebrow:'Una ficha de Lucy · 1962', coords:[-43.17,-22.91], dx:12, dy:-9, text:'El índice de una ficha migratoria ubica un trámite de Lucy en Río de Janeiro en 1962. La imagen todavía no está disponible y el registro no demuestra una mudanza permanente. No se reconstruye un viaje a partir de ese dato aislado.', source:'lucy'}
  };
  ...
  function choosePlace(id) {
    ...
    pointNodes.forEach((node,key)=>{node.classList.toggle('active',key===id);node.setAttribute('aria-pressed',String(key===id));});
    ...
    const link=document.createElement('a');link.href='#s-'+p.source;link.textContent='Ver los documentos ↗';
